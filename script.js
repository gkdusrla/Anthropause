...
function render(nowState)
{
    switch(nowState)
    {
        ...
        case 1:{ // 앤스로포즈 
            ...
            scrollC.style.opactiy = 0;
            scrollT.style.opactiy = 0;
            scrollA.style.opactiy = 0;
            introTypo.style.opactiy = 0;
            blackWall.style.opactiy = 0;
        ...
        case 5:{
            ...
            peoples[1].style.opacity = 0;
            bgnature.style.opacity = 0; // 6번에서 나타날 자연을 역스크롤 했을 때 사라질 수 있도록 처리.
            scrollC.style.opactiy = 0;
            scrollT.style.opactiy = 0;
            scrollA.style.opactiy = 0;
            introTypo.style.opactiy = 0;
        ...
        case 6:{
            ...
            natureMoveX = calcAni(animationKeyframes[6].animationVal.natureMoveX);
            natureMoveY = calcAni(animationKeyframes[6].animationVal.natureMoveY);
            natureScale = calcAni(animationKeyframes[6].animationVal.natureScale);
            ...
            peoples[0].style.opacity = 0;
            bgivy.style.opacity = 0; // 역시 7번에 나타날 담쟁이를 역스크롤 했을 때 사라질 수 있도록 처리. 
            // 더 확실하게 하고 싶다면 5번씬에도 넣어주게 되면 혹시나 씬을 2개 뛰어넘어도 사라지게 할 수 있겠죠? 
            scrollC.style.opactiy = 0;
            scrollT.style.opactiy = 0;
            scrollA.style.opactiy = 0;
            introTypo.style.opactiy = 0;
...
/* 덩굴 */
        ...
        case 8:{
            ...
            nature1MoveX = calcAni(animationKeyframes[8].animationVal.nature1MoveX);
            nature1MoveY = calcAni(animationKeyframes[8].animationVal.nature1MoveY);
            nature1Scale = calcAni(animationKeyframes[8].animationVal.nature1Scale);
...
/* 사라지는 엔딩 */
        ...
        case 31:{
            ...
            scrollEC.style.opacity = 0; 
            scrollET.style.opacity = 0;
            scrollC.style.opactiy = 0;
            scrollT.style.opactiy = 0;
            scrollA.style.opactiy = 0;
            introTypo.style.opactiy = 0;
